...
TRAIN_SCRIPT = BASE_DIR / "01_train_v4_3_1.py"
PREDICT_SCRIPT = BASE_DIR / "02_predict_v4_3_1.py"
VALIDATE_SCRIPT = BASE_DIR / "03_validate_v4_3_1.py"
VERIFY_SCRIPT = BASE_DIR / "04_verify_v4_3_1.py"


def parse_args():
    parser = argparse.ArgumentParser(description="本地负荷预测运行器 v4.3.1")
    parser.add_argument(
        "--mode",

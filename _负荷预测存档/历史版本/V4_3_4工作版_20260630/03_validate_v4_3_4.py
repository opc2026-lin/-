...
def compute_metrics(y_true, y_pred):
    ...
    return round(float(mae), 3), round(float(rmse), 3), round(float(mape), 3)


def parse_args():
    parser = argparse.ArgumentParser(description="负荷预测真实回测 v4.3.4")

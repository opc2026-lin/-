...
TRAIN_SCRIPT = BASE_DIR / "01_train_v4_3_6.py"
PREDICT_SCRIPT = BASE_DIR / "02_predict_v4_3_6.py"
VALIDATE_SCRIPT = BASE_DIR / "03_validate_v4_3_6.py"
VERIFY_SCRIPT = BASE_DIR / "04_verify_v4_3_6.py"


def parse_args():
    parser = argparse.ArgumentParser(description="负荷预测本地运行器 v4.3.6")
    parser.add_argument(
        "--mode",

...
TRAIN_SCRIPT = BASE_DIR / "01_train_v4_3_9.py"
PREDICT_SCRIPT = BASE_DIR / "02_predict_v4_3_9.py"
VALIDATE_SCRIPT = BASE_DIR / "03_validate_v4_3_9.py"
VERIFY_SCRIPT = BASE_DIR / "04_verify_v4_3_9.py"


def parse_args():
    parser = argparse.ArgumentParser(description="负荷预测本地运行器 v4.3.9")
    parser.add_argument(
        "--mode",

...
TRAIN_SCRIPT = BASE_DIR / "01_train_v4_0.py"
PREDICT_SCRIPT = BASE_DIR / "02_predict_v4_0.py"
VALIDATE_SCRIPT = BASE_DIR / "03_validate_v4_0.py"


def parse_args():
    parser = argparse.ArgumentParser(description="本地负荷预测运行器 v4.0")
    parser.add_argument(
        "--mode",
